...
metadata {
	definition(name: "Motion Detector", namespace: "hayun", author: "sunghunha", runLocally: false, mnmn: "SmartThings", vid: "generic-motion-2") {
		...
		fingerprint profileId: "0104", deviceId: "0402", inClusters: "0000 0001 0003 0500", manufacturer: "_TZ3000_msl6wxk9", model: "TS0202", deviceJoinName: "ZM-35H-Q" //TUYA Motion Sensor
	}
...
def getBatteryPercentageResult(rawValue) {
	...
	if (0 <= rawValue && rawValue <= 200) {
        ...
        else if(manufacturer == "_TZ3000_msl6wxk9") {
